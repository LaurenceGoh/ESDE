        ...
        return new Promise((resolve, reject) => {
            ...
            pool.getConnection((err, connection) => {
                if (err) {
                    ...
                    `UPDATE file SET design_title ='${title}' , design_description='${description}' WHERE file_id=${recordId}`
                    // DROP TABLES --
...
module.exports.createOneEmailInvitation =  (userData,recipientName, recipientEmail) => {
  ...
  let info =  transporter.sendMail({
    ...
    text: `Hi ${recipientName} You have been invited by your friend, ${userData.fullname} to participate in a competition at http://54.242.53.126:3001`, // plain text body
    html: `Hi ${recipientName} You have been invited by your friend, ${userData.fullname} to participate in a competition at http://54.242.53.126:3001`, // html body
  });
